...
class SQL_Backup_Test extends PageTestCase {
	...
	public function testImportNewMatosNoUnit() {
		...
		$expectedDataSet = new PHPUnit_Extensions_Database_DataSet_CompositeDataSet(array($this->getDataSet(), new ArrayDataSet(array(
				'robert_matos_detail' => array(
					array('id' => 4, 'label' => 'Designation 1', 'ref' => 'SQL_Backup_Test::testImportNewMatosNoUnit::1',
						'categorie' => 'son', 'sousCateg' => 5, 'tarifLoc' => 2.0, 'valRemp' => 3.0, 'remarque' => 'Cas nominal'),
					array('id' => 5, 'label' => 'Designation 2', 'ref' => 'SQL_Backup_Test::testImportNewMatosNoUnit::2',
						'categorie' => 'lumiere', 'sousCateg' => 16, 'tarifLoc' => 2.5, 'valRemp' => 19.99, 'remarque' => 'Valeur et tarif non entiers'),
					array('id' => 6, 'label' => 'Designation 3', 'ref' => 'SQL_Backup_Test::testImportNewMatosNoUnit::3',
						'categorie' => 'structure', 'sousCateg' => 10, 'tarifLoc' => 0.0, 'valRemp' => 0.0, 'remarque' => 'Valeur et tarif nuls'),
					array('id' => 7, 'label' => 'Designation 4', 'ref' => 'SQL_Backup_Test::testImportNewMatosNoUnit::4',
						'categorie' => 'transport', 'sousCateg' => 21, 'tarifLoc' => 6.0, 'valRemp' => 7.0, 'remarque' => 'Materiel externe'),
					array('id' => 8, 'label' => 'Designation 5', 'ref' => 'SQL_Backup_Test::testImportNewMatosNoUnit::5',
						'categorie' => 'son', 'sousCateg' => 2, 'tarifLoc' => 15.0, 'valRemp' => 30.0, 'remarque' => 'Pannes')),
				'robert_matos_generique' => array(
					array('id_matosdetail' => 4, 'quantite' => 1, 'panne' => 0, 'dateAchat' => '2016-05-31', 'ownerExt' => null),
					array('id_matosdetail' => 5, 'quantite' => 10, 'panne' => 0, 'dateAchat' => '2016-05-30', 'ownerExt' => null),
					array('id_matosdetail' => 6, 'quantite' => 4, 'panne' => 0, 'dateAchat' => '2016-05-29', 'ownerExt' => null),
					array('id_matosdetail' => 7, 'quantite' => 5, 'panne' => 0, 'dateAchat' => null, 'ownerExt' => 'EXT'),
					array('id_matosdetail' => 8, 'quantite' => 20, 'panne' => 8, 'dateAchat' => '2016-05-28', 'ownerExt' => null))))));
		foreach (self::$tables as $tableName) {
			$this->assertTableContents($expectedDataSet->getTable($tableName), $tableName);
		}
	}
	...
	public function testImportUpdateMatosAllUnits() {
		...
		$unchangingDataSet = new ArrayDataSet(array(
				'robert_matos_detail' => array(
					array('id' => 14, 'label' => 'Designation', 'ref' => 'SQL_Backup_Test::testImportUpdateMatosAllUnits::11',
						'categorie' => 'son', 'sousCateg' => 5, 'tarifLoc' => 1.0, 'valRemp' => 2.0, 'remarque' => "Modification de la date d'achat"),
					array('id' => 15, 'label' => 'Designation', 'ref' => 'SQL_Backup_Test::testImportUpdateMatosAllUnits::12',
						'categorie' => 'son', 'sousCateg' => 5, 'tarifLoc' => 1.0, 'valRemp' => 2.0, 'remarque' => 'Modification du prestataire externe'),
					array('id' => 17, 'label' => 'Designation', 'ref' => 'SQL_Backup_Test::testImportUpdateMatosAllUnits::14',
						'categorie' => 'son', 'sousCateg' => 5, 'tarifLoc' => 1.0, 'valRemp' => 2.0, 'remarque' => "Changement d'interne en externe"),
					array('id' => 18, 'label' => 'Designation', 'ref' => 'SQL_Backup_Test::testImportUpdateMatosAllUnits::15',
		...
		$this->insertData(new ArrayDataSet(array(
				'robert_matos_detail' => array(
					array('id' => 4, 'label' => 'Designation', 'ref' => 'SQL_Backup_Test::testImportUpdateMatosAllUnits::1',
						'categorie' => 'son', 'sousCateg' => 5, 'tarifLoc' => 1.0, 'valRemp' => 2.0, 'remarque' => 'Modification du code-barres'), //TODO revoir codes-barres
					array('id' => 5, 'label' => 'Designation', 'ref' => 'SQL_Backup_Test::testImportUpdateMatosAllUnits::2',
						'categorie' => 'son', 'sousCateg' => 5, 'tarifLoc' => 1.0, 'valRemp' => 2.0, 'remarque' => 'Modification de la reference'),
					array('id' => 6, 'label' => 'Designation', 'ref' => 'SQL_Backup_Test::testImportUpdateMatosAllUnits::3',
						'categorie' => 'son', 'sousCateg' => 5, 'tarifLoc' => 1.0, 'valRemp' => 2.0, 'remarque' => 'Modification de la designation'),
					array('id' => 7, 'label' => 'Designation', 'ref' => 'SQL_Backup_Test::testImportUpdateMatosAllUnits::4',
						'categorie' => 'son', 'sousCateg' => 5, 'tarifLoc' => 1.0, 'valRemp' => 2.0, 'remarque' => 'Modification de la categorie'),
					array('id' => 8, 'label' => 'Designation', 'ref' => 'SQL_Backup_Test::testImportUpdateMatosAllUnits::5',
						'categorie' => 'son', 'sousCateg' => 5, 'tarifLoc' => 1.0, 'valRemp' => 2.0, 'remarque' => 'Modification de la sous-categorie'),
					array('id' => 9, 'label' => 'Designation', 'ref' => 'SQL_Backup_Test::testImportUpdateMatosAllUnits::6',
						'categorie' => 'son', 'sousCateg' => 5, 'tarifLoc' => 1.0, 'valRemp' => 2.0, 'remarque' => 'Modification du tarif de location'),
					array('id' => 10, 'label' => 'Designation', 'ref' => 'SQL_Backup_Test::testImportUpdateMatosAllUnits::7',
						'categorie' => 'son', 'sousCateg' => 5, 'tarifLoc' => 1.0, 'valRemp' => 2.0, 'remarque' => 'Modification du tarif de location'),
					array('id' => 11, 'label' => 'Designation', 'ref' => 'SQL_Backup_Test::testImportUpdateMatosAllUnits::8',
						'categorie' => 'son', 'sousCateg' => 5, 'tarifLoc' => 1.0, 'valRemp' => 2.0, 'remarque' => 'Modification de la valeur de remplacement'),
					array('id' => 12, 'label' => 'Designation', 'ref' => 'SQL_Backup_Test::testImportUpdateMatosAllUnits::9',
						'categorie' => 'son', 'sousCateg' => 5, 'tarifLoc' => 1.0, 'valRemp' => 2.0, 'remarque' => 'Modification de la valeur de remplacement'),
					array('id' => 13, 'label' => 'Designation', 'ref' => 'SQL_Backup_Test::testImportUpdateMatosAllUnits::10',
						'categorie' => 'son', 'sousCateg' => 5, 'tarifLoc' => 1.0, 'valRemp' => 2.0, 'remarque' => 'Modification de la remarque'),
					array('id' => 16, 'label' => 'Designation', 'ref' => 'SQL_Backup_Test::testImportUpdateMatosAllUnits::13',
		...
		$expectedDataSet = new PHPUnit_Extensions_Database_DataSet_CompositeDataSet(array($this->getDataSet(),
				$unchangingDataSet, new ArrayDataSet(array(
					'robert_matos_detail' => array(
						...
						array('id' => 5, 'label' => 'Designation', 'ref' => 'SQL_Backup_Test::testImportUpdateMatosAllUnits::2_NEW',
							'categorie' => 'son', 'sousCateg' => 5, 'tarifLoc' => 1.0, 'valRemp' => 2.0, 'remarque' => 'Modification de la reference'),
						array('id' => 6, 'label' => 'Designation_NEW', 'ref' => 'SQL_Backup_Test::testImportUpdateMatosAllUnits::3',
							'categorie' => 'son', 'sousCateg' => 5, 'tarifLoc' => 1.0, 'valRemp' => 2.0, 'remarque' => 'Modification de la designation'),
						array('id' => 7, 'label' => 'Designation', 'ref' => 'SQL_Backup_Test::testImportUpdateMatosAllUnits::4',
						...
						array('id' => 16, 'label' => 'Designation_NEW', 'ref' => 'SQL_Backup_Test::testImportUpdateMatosAllUnits::13_NEW',
