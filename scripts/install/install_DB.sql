...
-- TABLE matos_generique

DROP TABLE IF EXISTS `robert_matos_generique`;
...
DROP TABLE IF EXISTS `robert_matos_ident`;
...
-- VIEW sum_matos_ident

DROP VIEW IF EXISTS `robert_view_sum_matos_ident`;
...
DROP VIEW IF EXISTS `robert_view_matos_detail`;
